import { EducationReward } from './EducationReward';
import { useEducationVisible } from './educationScore';
...
export function FullscreenControl() {
  ...
  const educational = useEducationVisible();
  ...
  return <aside className={`app-toolbar ${educational ? 'education-active' : ''}`} aria-label="Réglages de l’application">
